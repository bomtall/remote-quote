...
def test_surface_with_only_area(args, kwargs, expected):
    s = surface.SurfaceWithOnlyArea(*args, **kwargs)
...
def test_surface_with_only_area_error(args, kwargs, error_type, error_message):
    with pytest.raises(error_type) as e:
        surface.SurfaceWithOnlyArea(*args, **kwargs)
